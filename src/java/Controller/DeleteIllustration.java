...
import static Controller.Java_JDBC.deleteIllustrationFromDatabase;
 ...
 * @author LENOVO
 */
@WebServlet(name="DeleteIllustration", urlPatterns={"/DeleteIllustration"})
public class DeleteIllustration extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("deleteIllustration.jsp").forward(request, response);
   ...
   Novel novel = Java_JDBC.getNovelByNovelId(con, novelId);
            ...
            List<Illustration> illuList =IllustrationList.getIllustrationsForNovel(novel);
            request.setAttribute("illuList", illuList);
            ...
            request.getRequestDispatcher("deleteIllustration.jsp").forward(request, response);
              ...
              try {
                  ...
                  Logger.getLogger(DeleteIllustration.class.getName()).log(Level.SEVERE, null, ex1);
              }
        } catch (Exception ex) {
              try {
                  processRequest(request,response);
...
protected void doPost(HttpServletRequest request, HttpServletResponse response)
        throws ServletException, IOException {
    String illustrationId = request.getParameter("IllustrationId");
    
    try {
        boolean IlluDeleted = deleteIllustrationFromDatabase(illustrationId);
